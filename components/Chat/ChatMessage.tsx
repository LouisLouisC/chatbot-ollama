    ...
    >
      <div className="relative m-auto flex p-4 text-base md:max-w-2xl md:gap-6 md:py-6 lg:max-w-2xl lg:px-0 xl:max-w-3xl">
        <div className="flex w-full items-center">
          ...
          {message.role === 'user' && (
            <div className="min-w-[40px] text-left mr-2 border border-gray-500 rounded-full p-1">
              <img src={userLogo.src} alt="User Icon" width={30} height={30} />
            </div>
          )}
            ...
            {message.role === 'user' ? (
                ...
                {isEditing ? (
                  <div className="flex w-full flex-col">
                    ...
                    <div className="mt-10 flex justify-center space-x-4">
                      <button
                        className="h-[40px] rounded-md bg-blue-500 px-4 py-1 text-sm font-medium text-gray-800 enabled:hover:bg-white disabled:opacity-50"
              ...
              <div className="flex flex-row">
                <MemoizedReactMarkdown
                  className="prose dark:prose-invert flex-1 !text-gray-800"
          ...
          {/* Bot Logo on the Right */}
          {message.role === 'assistant' && (
            <div className="min-w-[40px] text-right ml-2 border border-blue-500 rounded-full p-1">

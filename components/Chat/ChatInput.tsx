      ...
      <div className="stretch mx-2 mt-4 flex flex-row gap-3 last:mb-2 md:mx-4 md:mt-[50px] md:last:mb-6 lg:mx-auto lg:max-w-3xl">
        ...
        {/* {!messageIsStreaming &&
          ...
          selectedConversation.messages.length > 0 && (
            <button
              className="absolute top-0 left-0 right-0 mx-auto mb-3 flex w-fit items-center gap-3 rounded border border-neutral-200 py-2 px-4 text-black hover:opacity-50 dark:border-neutral-600 dark:text-white md:mb-0 md:mt-2"
